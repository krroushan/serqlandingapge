            ...
            <div className="container mx-auto px-4 max-w-6xl relative z-10">
                <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="order-2 md:order-1 relative">
                        {/* Status badge - "LIVE" */}
                        {/* <div className="absolute -top-10 -left-2 flex items-center bg-black text-white text-xs px-3 py-1.5 rounded-full shadow-lg animate-pulse">
                        ...
                        {/* Feature badge */}
                        <div className="inline-flex items-center mb-6 px-3 py-1 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-full shadow-sm">
